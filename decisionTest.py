...
Train an agent on the mini decision game
"""

from minidecisionAgent import DQLDecision, preprocess
...
def train(path, episodes=100, init_model=None, exploration_max=1,
    ...
    from minigames import miniDecisionGame

    env = miniDecisionGame()

    dino = DQLDecision(3, input_shape=(100, 100, 1),
                       mem_size=50000,
                       learning_rate=0.001,
